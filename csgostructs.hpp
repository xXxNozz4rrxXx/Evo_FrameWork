...
{
public:
	NETVAR(bool, m_bFreezePeriod, "DT_CSGameRulesProxy", "m_bFreezePeriod"); //0x20
	NETVAR(bool, m_bBombPlanted, "DT_CSGameRulesProxy", "m_bBombPlanted"); //0x99D
};
...
public:
	...
	uintptr_t econ_item_interface_wrapper_offset() {
		auto offset = NetvarSys::Get().GetOffset("DT_BaseAttributableItem", "m_Item") + 0xC;
		return offset;
	}
...
public:
	...
	PNETVAR(bool, m_bIsAutoaimTarget, "DT_BaseEntity", "m_bIsAutoaimTarget");
	...
	int& GetIndex() { return *reinterpret_cast<int*>(m_bIsAutoaimTarget() + 0x4); }
	bool IsPlayer();
	bool IsWeapon();
	bool IsPlantedC4();
	bool IsDefuseKit();
...
public:
	...
	PNETVAR(float, m_flFlashMaxAlpha, "DT_CSPlayer", "m_flFlashMaxAlpha");
